...
namespace PayPerPlace.Metro
{
    ...
    /// </summary>
    public sealed partial class CreateNewChallengePage : PayPerPlace.Metro.Common.LayoutAwarePage
    {
	...
	private void pushpinTapped(object sender, TappedRoutedEventArgs e)
        ...
        //var location = e.target.tryPixelToLocation(pos);
        Location location;
		map.TryPixelToLocation(pos, out location);
        Pushpin pin = new Pushpin(); 
        //pin.Background = new SolidColorBrush(Windows.UI.Color.);
		map.Children.Add(pin);
        Location centrePoint = map.Center;
